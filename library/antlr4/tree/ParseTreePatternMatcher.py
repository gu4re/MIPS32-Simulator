...
from library.antlr4.ListTokenSource import ListTokenSource
from library.antlr4.Token import Token
from library.antlr4.error.ErrorStrategy import BailErrorStrategy
from library.antlr4.error.Errors import RecognitionException, ParseCancellationException
from library.antlr4.tree.Chunk import TagChunk, TextChunk
from library.antlr4.tree.RuleTagToken import RuleTagToken
from library.antlr4.tree.TokenTagToken import TokenTagToken
from library.antlr4.tree.Tree import ParseTree, TerminalNode, RuleNode
...
class ParseTreePatternMatcher(object):
    ...
    def matchPattern(self, tree:ParseTree, pattern:ParseTreePattern):
        ...
        from library.antlr4.tree.ParseTreeMatch import ParseTreeMatch
    ...
    def compileTreePattern(self, pattern:str, patternRuleIndex:int):
        ...
        from library.antlr4.ParserInterpreter import ParserInterpreter
        ...
        from library.antlr4.tree.ParseTreePattern import ParseTreePattern
